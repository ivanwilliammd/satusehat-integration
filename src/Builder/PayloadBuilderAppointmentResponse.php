 ...
 * @link https://www.hl7.org/fhir/appointmentresponse.html
 */
class PayloadBuilderAppointmentResponse extends Builder
{
    protected string $resourceType = 'AppointmentResponse';
