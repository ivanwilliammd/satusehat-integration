...
/**
 * BiologicallyDerivedProduct FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/biologicallyderivedproduct.html
 */
class PayloadBuilderBiologicallyDerivedProduct extends Builder
{
    protected string $resourceType = 'BiologicallyDerivedProduct';
