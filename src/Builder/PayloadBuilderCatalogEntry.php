...
/**
 * CatalogEntry FHIR R4 Resource Builder
 * @link https://hl7.org/fhir/R4/catalogentry.html
 */
class PayloadBuilderCatalogEntry extends Builder
{
    protected string $resourceType = 'CatalogEntry';
    ...
    public function setReference(string $reference, ?string $display = null): self
    {
        $ref = ['reference' => $reference];
        if ($display !== null) $ref['display'] = $display;
        $this->set('reference', $ref);
        return $this;
    }
