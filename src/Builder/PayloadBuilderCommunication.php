...
/**
 * Communication FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/communication.html
 */
class PayloadBuilderCommunication extends Builder
{
    protected string $resourceType = 'Communication';
