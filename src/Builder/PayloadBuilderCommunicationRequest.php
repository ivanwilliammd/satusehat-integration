...
/**
 * CommunicationRequest FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/communicationrequest.html
 */
class PayloadBuilderCommunicationRequest extends Builder
{
    protected string $resourceType = 'CommunicationRequest';
