...
/**
 * Consent FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/consent.html
 */
class PayloadBuilderConsent extends Builder
{
    protected string $resourceType = 'Consent';
