...
/**
 * Contract FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/contract.html
 */
class PayloadBuilderContract extends Builder
{
    protected string $resourceType = 'Contract';
