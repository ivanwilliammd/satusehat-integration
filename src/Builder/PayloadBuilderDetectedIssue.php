...
/**
 * DetectedIssue FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/detectedissue.html
 */
class PayloadBuilderDetectedIssue extends Builder
{
    protected string $resourceType = 'DetectedIssue';
