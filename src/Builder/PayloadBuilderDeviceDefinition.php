...
/**
 * DeviceDefinition FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/devicedefinition.html
 */
class PayloadBuilderDeviceDefinition extends Builder
{
    protected string $resourceType = 'DeviceDefinition';
