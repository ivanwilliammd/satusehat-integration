...
/**
 * DeviceMetric FHIR R4 Resource Builder
 * @link https://hl7.org/fhir/R4/devicemetric.html
 */
class PayloadBuilderDeviceMetric extends Builder
{
    protected string $resourceType = 'DeviceMetric';
    ...
    public function setMeasurementPeriod(string $value): self
    {
        $this->set('measurementPeriod', $value);
        return $this;
    }
}
