 ...
 * @link https://www.hl7.org/fhir/deviceusestatement.html
 */
class PayloadBuilderDeviceUseStatement extends Builder
{
    protected string $resourceType = 'DeviceUseStatement';
