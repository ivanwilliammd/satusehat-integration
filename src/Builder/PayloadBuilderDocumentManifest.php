...
/**
 * DocumentManifest FHIR R4 Resource Builder
 * @link https://hl7.org/fhir/R4/documentmanifest.html
 */
class PayloadBuilderDocumentManifest extends Builder
{
    protected string $resourceType = 'DocumentManifest';
    ...
    public function setSource(string $reference, ?string $display = null): self
    {
        $ref = ['reference' => $reference];
        if ($display !== null) $ref['display'] = $display;
        $this->set('source', $ref);
