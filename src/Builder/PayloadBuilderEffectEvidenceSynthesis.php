...
/**
 * EffectEvidenceSynthesis FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/effectevidencesynthesis.html
 */
class PayloadBuilderEffectEvidenceSynthesis extends Builder
{
    protected string $resourceType = 'EffectEvidenceSynthesis';
