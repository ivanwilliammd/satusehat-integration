...
/**
 * EnrollmentRequest FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/enrollmentrequest.html
 */
class PayloadBuilderEnrollmentRequest extends Builder
{
    protected string $resourceType = 'EnrollmentRequest';
