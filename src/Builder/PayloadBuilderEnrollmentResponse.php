...
/**
 * EnrollmentResponse FHIR R4 Resource Builder
 * @link https://hl7.org/fhir/R4/enrollmentresponse.html
 */
class PayloadBuilderEnrollmentResponse extends Builder
{
    protected string $resourceType = 'EnrollmentResponse';
    ...
    public function setRequest(string $reference, ?string $display = null): self
    {
        ...
        $this->set('request', $ref);
        return $this;
    }

    public function setOutcome(string $system, string $code, string $display = ''): self
    {
        $this->set('outcome', [
