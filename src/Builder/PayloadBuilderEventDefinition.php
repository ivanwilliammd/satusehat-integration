...
/**
 * EventDefinition FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/eventdefinition.html
 */
class PayloadBuilderEventDefinition extends Builder
{
    protected string $resourceType = 'EventDefinition';
