...
/**
 * Evidence FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/evidence.html
 */
class PayloadBuilderEvidence extends Builder
{
    protected string $resourceType = 'Evidence';
