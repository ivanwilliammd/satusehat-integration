...
/**
 * EvidenceVariable FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/evidencevariable.html
 */
class PayloadBuilderEvidenceVariable extends Builder
{
    protected string $resourceType = 'EvidenceVariable';
