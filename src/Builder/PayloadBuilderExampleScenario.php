...
/**
 * ExampleScenario FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/examplescenario.html
 */
class PayloadBuilderExampleScenario extends Builder
{
    protected string $resourceType = 'ExampleScenario';
