...
/**
 * GuidanceResponse FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/guidanceresponse.html
 */
class PayloadBuilderGuidanceResponse extends Builder
{
    protected string $resourceType = 'GuidanceResponse';
