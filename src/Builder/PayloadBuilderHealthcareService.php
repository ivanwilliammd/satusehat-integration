...
/**
 * HealthcareService FHIR R4 Resource Builder
 * @link https://hl7.org/fhir/R4/healthcareservice.html
 */
class PayloadBuilderHealthcareService extends Builder
{
    ...
    public function setLocation(string $reference, ?string $display = null): self
    {
    ...
    public function setProvidedBy(string $reference, ?string $display = null): self
    {
        $ref = ['reference' => $reference];
        if ($display !== null) $ref['display'] = $display;
        $this->set('providedBy', $ref);
        return $this;
    }
}
