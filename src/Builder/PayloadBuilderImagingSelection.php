...
/**
 * ImagingSelection FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/imagingselection.html
 */
class PayloadBuilderImagingSelection extends Builder
{
    protected string $resourceType = 'ImagingSelection';
