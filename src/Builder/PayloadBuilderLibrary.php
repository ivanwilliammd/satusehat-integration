...
/**
 * Library FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/library.html
 */
class PayloadBuilderLibrary extends Builder
{
    protected string $resourceType = 'Library';
