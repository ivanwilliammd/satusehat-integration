...
/**
 * Linkage FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/linkage.html
 */
class PayloadBuilderLinkage extends Builder
{
    protected string $resourceType = 'Linkage';
