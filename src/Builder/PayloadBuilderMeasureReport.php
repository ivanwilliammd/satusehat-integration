...
/**
 * MeasureReport FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/measurereport.html
 */
class PayloadBuilderMeasureReport extends Builder
{
    protected string $resourceType = 'MeasureReport';
