...
/**
 * MedicationKnowledge FHIR R4 Resource Builder
 * @link https://hl7.org/fhir/R4/medicationknowledge.html
 */
class PayloadBuilderMedicationKnowledge extends Builder
{
    protected string $resourceType = 'MedicationKnowledge';
