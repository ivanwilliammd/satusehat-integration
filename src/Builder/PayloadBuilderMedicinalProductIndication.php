 ...
 * @link https://hl7.org/fhir/R4/medicinalproductindication.html
 */
class PayloadBuilderMedicinalProductIndication extends Builder
{
    protected string $resourceType = 'MedicinalProductIndication';
