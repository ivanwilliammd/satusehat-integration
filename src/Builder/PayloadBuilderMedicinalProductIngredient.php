 ...
 * @link https://hl7.org/fhir/R4/medicinalproductingredient.html
 */
class PayloadBuilderMedicinalProductIngredient extends Builder
{
    protected string $resourceType = 'MedicinalProductIngredient';
    ...
    public function setRole(string $system, string $code, string $display = ''): self
    {
        $this->set('role', [
    ...
    public function setSubstance(string $value): self
    {
        $this->set('substance', $value);
        return $this;
    }
