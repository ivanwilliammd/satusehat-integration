 ...
 * @link https://hl7.org/fhir/R4/medicinalproductpackaged.html
 */
class PayloadBuilderMedicinalProductPackaged extends Builder
{
    protected string $resourceType = 'MedicinalProductPackaged';
    ...
    public function setPackageItem(string $system, string $code, string $display = ''): self
    {
        $this->set('packageItem', [
