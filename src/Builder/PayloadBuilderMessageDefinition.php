...
/**
 * MessageDefinition FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/messagedefinition.html
 */
class PayloadBuilderMessageDefinition extends Builder
{
    protected string $resourceType = 'MessageDefinition';
