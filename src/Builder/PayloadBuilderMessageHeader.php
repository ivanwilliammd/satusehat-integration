...
/**
 * MessageHeader FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/messageheader.html
 */
class PayloadBuilderMessageHeader extends Builder
{
    protected string $resourceType = 'MessageHeader';
