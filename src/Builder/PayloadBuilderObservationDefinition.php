...
/**
 * ObservationDefinition FHIR R4 Resource Builder
 * @link https://hl7.org/fhir/R4/observationdefinition.html
 */
class PayloadBuilderObservationDefinition extends Builder
{
    protected string $resourceType = 'ObservationDefinition';
    ...
    public function setCategory(string $system, string $code, string $display = ''): self
    {
        $this->set('category', [
            'coding' => [['system' => $system, 'code' => $code, 'display' => $display]],
        ]);
    ...
    public function setMethod(string $system, string $code, string $display = ''): self
    {
        $this->set('method', [
            'coding' => [['system' => $system, 'code' => $code, 'display' => $display]],
        ]);
