...
/**
 * OperationOutcome FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/operationoutcome.html
 */
class PayloadBuilderOperationOutcome extends Builder
{
    protected string $resourceType = 'OperationOutcome';
