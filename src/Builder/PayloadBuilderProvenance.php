...
/**
 * Provenance FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/provenance.html
 */
class PayloadBuilderProvenance extends Builder
{
    protected string $resourceType = 'Provenance';
