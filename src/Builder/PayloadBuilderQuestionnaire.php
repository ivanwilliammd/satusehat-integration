...
/**
 * Questionnaire FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/questionnaire.html
 */
class PayloadBuilderQuestionnaire extends Builder
{
    protected string $resourceType = 'Questionnaire';
