...
/**
 * ResearchDefinition FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/researchdefinition.html
 */
class PayloadBuilderResearchDefinition extends Builder
{
    protected string $resourceType = 'ResearchDefinition';
