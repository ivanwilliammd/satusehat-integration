...
/**
 * ResearchSubject FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/researchsubject.html
 */
class PayloadBuilderResearchSubject extends Builder
{
    protected string $resourceType = 'ResearchSubject';
