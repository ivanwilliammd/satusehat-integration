...
/**
 * RiskEvidenceSynthesis FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/riskevidencesynthesis.html
 */
class PayloadBuilderRiskEvidenceSynthesis extends Builder
{
    protected string $resourceType = 'RiskEvidenceSynthesis';
