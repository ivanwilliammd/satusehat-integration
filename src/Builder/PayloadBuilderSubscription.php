...
/**
 * Subscription FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/subscription.html
 */
class PayloadBuilderSubscription extends Builder
{
    protected string $resourceType = 'Subscription';
