...
/**
 * SubstanceNucleicAcid FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/substancenucleicacid.html
 */
class PayloadBuilderSubstanceNucleicAcid extends Builder
{
    protected string $resourceType = 'SubstanceNucleicAcid';
