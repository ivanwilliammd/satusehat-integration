...
/**
 * SubstancePolymer FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/substancepolymer.html
 */
class PayloadBuilderSubstancePolymer extends Builder
{
    protected string $resourceType = 'SubstancePolymer';
