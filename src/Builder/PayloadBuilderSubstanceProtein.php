...
/**
 * SubstanceProtein FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/substanceprotein.html
 */
class PayloadBuilderSubstanceProtein extends Builder
{
    protected string $resourceType = 'SubstanceProtein';
