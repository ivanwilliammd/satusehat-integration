...
/**
 * SubstanceSourceMaterial FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/substancesourcematerial.html
 */
class PayloadBuilderSubstanceSourceMaterial extends Builder
{
    protected string $resourceType = 'SubstanceSourceMaterial';
