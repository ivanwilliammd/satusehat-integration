...
/**
 * SubstanceSpecification FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/substancespecification.html
 */
class PayloadBuilderSubstanceSpecification extends Builder
{
    protected string $resourceType = 'SubstanceSpecification';
