...
/**
 * SupplyRequest FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/supplyrequest.html
 */
class PayloadBuilderSupplyRequest extends Builder
{
    protected string $resourceType = 'SupplyRequest';
