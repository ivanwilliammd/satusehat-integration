...
/**
 * TestReport FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/testreport.html
 */
class PayloadBuilderTestReport extends Builder
{
    protected string $resourceType = 'TestReport';
