...
/**
 * TestScript FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/testscript.html
 */
class PayloadBuilderTestScript extends Builder
{
    protected string $resourceType = 'TestScript';
