...
/**
 * VerificationResult FHIR R4 Resource Builder
 * @link https://www.hl7.org/fhir/verificationresult.html
 */
class PayloadBuilderVerificationResult extends Builder
{
    protected string $resourceType = 'VerificationResult';
