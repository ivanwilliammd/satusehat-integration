 ...
 * @link https://www.hl7.org/fhir/visionprescription.html
 */
class PayloadBuilderVisionPrescription extends Builder
{
    protected string $resourceType = 'VisionPrescription';
